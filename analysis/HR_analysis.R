...
#'   B-cell ALL, Blina for Relapsed Disease
#'
#' Population:
...
#'
#' Outputs:
#'   - Model results saved under model-out/blin_1stline_nci-high-blin/
...
path.out <- "/model-out/blin_1stline_nci-high-blin/bsc/"
path.out2 <- "/model-out/blin_1stline_nci-high-blin/"
...
path.out <- "/model-out/blin_1stline_nci-high-blin/blin/"
path.out2 <- "/model-out/blin_1stline_nci-high-blin/"
