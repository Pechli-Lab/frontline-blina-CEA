...
#'   BSC for Relapsed Disease in NCI standard-risk B-cell ALL
#'
#' Population:
...
#'   Then for relapsed disease, all patients receive BSC.
#'
#' Sourced Scripts:
#'   analysis/00_setup.R
...
#' 
#' Outputs:
#'   - Model results saved under model-out/blin_1stline_relapse_bsc/
...
path.out <- "/model-out/blin_1stline_relapse_bsc/bsc/"
path.out2 <- "/model-out/blin_1stline_relapse_bsc/"
...
path.out <- "/model-out/blin_1stline_relapse_bsc/blin/"
path.out2 <- "/model-out/blin_1stline_relapse_bsc/"
